...
#define  W5100_SKT_OFFSET		0x0100		/* offset to each socket register set */
#define  W5100_SKT_BASE(n)	(W5100_SKT_REG_BASE+(n*W5100_SKT_OFFSET))

#define  W5100_NUM_SOCKETS		2


#define W5100_SK0_DST_IP 0x040C
#define W5100_SK0_DST_PT 0x0410
/*
...
#define  W5100_RX_RW_OFFSET		0x002A		/* socket Receive Write Pointer Register (2 bytes) Added From Arduino Lib Version */
...
#define  W5100_MR_AUTOINC		(1<<1)		/* address auto increment (indirect interface ONLY!) */
#define  W5100_MR_INDINT		(1<<0)		/* use indirect interface (parallel interface ONLY!) */

/*
 *  The following #defines are OR-masks for checking bits in the Interrupt Register,
...
#define  W5100_IR_S2_INT		(1<<3)		/* 1 means socket 2 interrupt occurred */
#define  W5100_IR_S1_INT		(1<<3)		/* 1 means socket 1 interrupt occurred */
#define  W5100_IR_S0_INT		(1<<3)		/* 1 means socket 0 interrupt occurred */
...
#define  W5100_IMR_S3_INT		(1<<3)		/* Enable interrupt for socket 3 interrupt */
#define  W5100_IMR_S2_INT		(1<<3)		/* Enable interrupt for socket 2 interrupt */
#define  W5100_IMR_S1_INT		(1<<3)		/* Enable interrupt for socket 1 interrupt */
#define  W5100_IMR_S0_INT		(1<<3)		/* Enable interrupt for socket 0 interrupt */
 ...
 */
#define  W5100_SKT_P3			(1<<3)		/* protocol selector bit 3 */
#define  W5100_SKT_P2			(1<<2)		/* protocol selector bit 2 */
#define  W5100_SKT_P1			(1<<1)		/* protocol selector bit 1 */
#define  W5100_SKT_P0			(1<<0)		/* protocol selector bit 0 */
...
#define  W5100_SKT_MR_MULTI	  	0x80	  	/* support multi casting */
